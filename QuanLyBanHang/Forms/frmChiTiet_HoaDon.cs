...
{
    public partial class frmChiTiet_HoaDon : Form
    {
        ...
        public frmChiTiet_HoaDon()
        {
            InitializeComponent();
        }

        public frmChiTiet_HoaDon(int maHoaDon = 0)
        {
            InitializeComponent();
            id = maHoaDon;
        }
        ...
        private void frmChiTiet_HoaDon_Load(object sender, EventArgs e)
        {
